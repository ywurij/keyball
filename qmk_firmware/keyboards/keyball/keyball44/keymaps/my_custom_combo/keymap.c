...
const uint16_t PROGMEM ui_up_combo[] = {KC_U, KC_I, COMBO_END};
const uint16_t PROGMEM df_rght_combo[] = {KC_D, KC_F, COMBO_END};
const uint16_t PROGMEM kl_rght_combo[] = {KC_K, KC_L, COMBO_END};
const uint16_t PROGMEM sd_left_combo[] = {KC_S, KC_D, COMBO_END};
const uint16_t PROGMEM jk_left_combo[] = {KC_J, KC_K, COMBO_END};
const uint16_t PROGMEM cv_down_combo[] = {KC_C, KC_V, COMBO_END};
const uint16_t PROGMEM mc_down_combo[] = {KC_M, KC_COMM, COMBO_END};
const uint16_t PROGMEM fg_tab_combo[] = {KC_F, KC_G, COMBO_END};
const uint16_t PROGMEM rt_esc_combo[] = {KC_R, KC_T, COMBO_END};
const uint16_t PROGMEM hj_ent_combo[] = {KC_H, KC_J, COMBO_END};
...
combo_t key_combos[] = {
  ...
  [UI_UP] = COMBO(ui_up_combo, KC_UP),
  [DF_RGHT] = COMBO(df_rght_combo, KC_RGHT),
  [KL_RGHT] = COMBO(kl_rght_combo, KC_RGHT),
  [SD_LEFT] = COMBO(sd_left_combo, KC_LEFT),
  [JK_LEFT] = COMBO(jk_left_combo, KC_LEFT),
  [CV_DOWN] = COMBO(cv_down_combo, KC_DOWN),
  [MC_DOWN] = COMBO(mc_down_combo, KC_DOWN),
  [FG_TAB] = COMBO(fg_tab_combo, KC_TAB),
  [RT_ESC] = COMBO(rt_esc_combo, KC_ESC),
  [HJ_ENT] = COMBO(hj_ent_combo, KC_ENT),
