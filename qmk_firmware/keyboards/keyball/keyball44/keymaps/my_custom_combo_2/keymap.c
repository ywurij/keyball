...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_universal(
    KC_NO ,  KC_NO , KC_NO  , KC_NO  , KC_NO    , KC_NO    ,                                                 KC_B     , KC_BTN1  , KC_BTN3  , KC_BTN2  , KC_RCTL  , KC_RSFT ,
    KC_NO ,  KC_NO , KC_NO  , KC_NO  , KC_LCTL  , KC_LSFT  ,                                                 SCRL_MO  , KC_BTN1  , KC_BTN3  , KC_BTN2  , KC_RCTL  , KC_RSFT ,
  ...
  [4] = LAYOUT_universal(
    ...
    KC_NO  , KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END ,                                                   KC_V   , KC_S   , KC_X   , KC_D   , KC_E   , KC_Z   ,
    KC_NO  , C(KC_Z), C(KC_X), C(KC_C), C(KC_V) , KC_NO  ,                                                   KC_B   , KC_Q   , KC_F   , KC_1  , KC_2  , KC_SPACE,
...
const uint16_t PROGMEM wer_tab_combo[] = {KC_W, KC_E, KC_R, COMBO_END};
...
combo_t key_combos[] = {
  ...
  [WER_TAB] = COMBO(wer_tab_combo, KC_TAB),
